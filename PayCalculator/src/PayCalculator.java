...
public class PayCalculator {
    ...
    public static final int MAX_NO_OVER_TIME = 160;//the number of hours avaliable for overtime
    public static final double OVER_TIME_RATE = 1.5;
    public static final double ENGINEER_HOURLY_PAY = 30.0;
    public static final double TECHNICIAN_HOURLY_PAY = 25.5;
    public static double salary;
    public static int hoursWorked = 160;
